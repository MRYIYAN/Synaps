...
const BrainCogIcon = ({ color = 'currentColor', size = 24, strokeWidth = 2, className = '' }) => {
  const [isHovered, setIsHovered] = useState(false);
  
  return (
    <div
      className={`brain-cog-icon-wrapper ${className}`}
    ...
    >
      ...
      >
        ...
        <g className={`cog-group ${isHovered ? 'animate' : ''}`}>
